...
Features:
- Menu displaying all functions of the student grade management system
...
Compilation and exuction instructions:
1. Open the project folder in the terminal
2. type: javac StudentGradeSystemMangagement.java
3. type: java StudentGradeSystemManagement
